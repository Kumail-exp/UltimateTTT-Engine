...
public class Main implements Callable<Integer> {
    ...
    static class Play implements Callable<Integer> {
        ...
        @Option(names = {"--depth"}, description = "Max search depth for AI", defaultValue = "28")
        int depth;

        @Option(names = {"--limit"}, description = "Time limit per move in ms (hard cap 30s)", defaultValue = "30000")
        long limitMs;
    ...
    static class Analyze implements Callable<Integer> {
        ...
        @Option(names = {"--depth"}, description = "Max depth", defaultValue = "28")
        int depth;

        @Option(names = {"--limit"}, description = "Time limit ms (hard cap 30s)", defaultValue = "30000")
        long limitMs;
