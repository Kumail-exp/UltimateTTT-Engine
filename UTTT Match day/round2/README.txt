Ultimate Tic-Tac-Toe Bot - Round 2
========================================
Hard time limit: 15 seconds per move (15000 ms)
Default max depth: 24
...
How to run (any OS):
  java -jar ultimattt-1.0.0.jar play --limit 15000 --depth 24 --log "Game 1.txt"
