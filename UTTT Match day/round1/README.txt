Ultimate Tic-Tac-Toe Bot - Round 1
========================================
Hard time limit: 10 seconds per move (10000 ms)
Default max depth: 22
...
How to run (any OS):
  java -jar ultimattt-1.0.0.jar play --limit 10000 --depth 22 --log "Game 1.txt"
