...
public class Main implements Callable<Integer> {
    ...
    static class Play implements Callable<Integer> {
        ...
        @Option(names = {"--depth"}, description = "Max search depth for AI", defaultValue = "22")
        int depth;

        @Option(names = {"--limit"}, description = "Time limit per move in ms (hard cap 10s)", defaultValue = "10000")
        long limitMs;
    ...
    static class Analyze implements Callable<Integer> {
        ...
        @Option(names = {"--depth"}, description = "Max depth", defaultValue = "22")
        int depth;

        @Option(names = {"--limit"}, description = "Time limit ms (hard cap 10s)", defaultValue = "10000")
        long limitMs;
